      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-push-3">
          ...
          <div class="tab-content tab-content-shop">
            ...
            <div class="tab-pane fade in active" id="top-selling-items">
              <div class="row mt-20">
                @each("$components.produtos", $loja->produtos, 'produto')
               </div>
            </div>
            <!-- TAB-CONTENT-2 -->
            <!--===============================================================-->
        ...
        <div class="col-sm-3 col-sm-pull-9">
          <div class="row-heading">
            <div class="col-sm-12">
              <h5 class="title-sm hr-left text-uppercase">Categorias</h5>
            </div>
                @each("$components.menu-categoria", $categoria, 'categoria')
          </div>              
        </div>    
        <!-- CATEGORIAS END -->
      </div>
